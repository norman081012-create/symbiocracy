...
DEFAULT_CONFIG = {
    ...
    'CURRENT_GDP': 5000.0, 
    'HEALTH_MULTIPLIER': 0.2, # GDP 轉化為總預算的比例 (20%)
    'P_B_RATIO': 0.05,        # 政黨基本金比例
    'P_R_RATIO': 0.10,        # 當權紅利比例
    'M_RESISTANCE': 5.0,      # 建設阻力倍率
    'DECAY_COEFF': 0.072,     # 衰退值轉衰退率係數
    'H_MEDIA_BONUS': 1.2, 'R_INV_BONUS': 1.2,
    'CORRUPTION_PENALTY': 2.0,
    'MAX_ABILITY': 20.0, 'ABILITY_DEFAULT': 3.0,
...
CONFIG_TRANSLATIONS = {
    ...
    'CURRENT_GDP': "初始 GDP", 'HEALTH_MULTIPLIER': "預算稅率(%)", 
    'P_B_RATIO': "政黨基本金(%)", 'P_R_RATIO': "當權紅利(%)", 'M_RESISTANCE': "建設阻力倍率",
